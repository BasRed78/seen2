...
const ds = {
  ...
  gold: '#F2B800',
  cardShadow: '0 2px 8px rgba(26,26,46,0.04)',
};
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          backgroundColor: 'rgba(0,0,0,0.25)', width: 110, height: 4, borderRadius: 2, zIndex: 50,
        }} />
      </div>
    </div>
  );
  ...
  return (
    <div>
      ...
      <div style={{ padding: '0 20px' }}>
        ...
        <div style={{ padding: 14, borderRadius: 16, backgroundColor: ds.surface, border: `1px solid ${ds.subtle}`, marginBottom: 12 }}>
        ...
        <div style={{ padding: 14, borderRadius: 16, backgroundColor: ds.surface, border: `1px solid ${ds.subtle}` }}>
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '0 20px' }}>
        ...
        <div style={{ padding: 14, borderRadius: 14, backgroundColor: ds.surface, border: `1px solid ${ds.subtle}`, marginBottom: 10 }}>
